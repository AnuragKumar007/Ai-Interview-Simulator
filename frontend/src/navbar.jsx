    ...
    return (
        ...
        <nav>
          <div className="nav-container">
            {/* Logo */}
            <NavLink to="/" className="logo text-[#2C3E50]">Interview Papa</NavLink>
            ...
            <div className="nav-links flex justify-center items-center rounded-full ">
              ...
              <NavLink to="/about" className={({isActive}) => isActive ? "text-[#2C3E50] hover:text-[#2C3E50] underline" : "text-[#34495E] hover:text-[#2C3E50]"}>About</NavLink>
              ...
              <Button 
              children ={"Sign Up"} 
              className={"text-sm rounded-full px-4 py-[0.5rem] "}
